...
for (var _index = 0; _index < buttonExpanders.length; _index++) {
	var buttonExpander = buttonExpanders[_index];
...
for (var _index2 = 0; _index2 < buttonDeExpanders.length; _index2++) {
	var buttonDeExpander = buttonDeExpanders[_index2];
...
function showFeedback(article, unrecognizable) {
	...
	var _nextArticle;
	_nextArticle = function nextArticle(e) {
		...
		e.target.removeEventListener("click", _nextArticle);
	...
	goToNextStep.addEventListener("click", _nextArticle);
}
...
for (var _index3 = 0; _index3 < recognizableButtons.length; _index3++) {
	var recognizableButton = recognizableButtons[_index3];
	recognizableButton.addEventListener("click", makeRecognizable);
}

for (var _index4 = 0; _index4 < unrecognizableButtons.length; _index4++) {
	var unrecognizableButton = unrecognizableButtons[_index4];
